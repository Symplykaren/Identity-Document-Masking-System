...
def redact_specific_regions(image_path, ocr_results, indices_to_redact):
...
img_path = '/home/prlab/Desktop/pythonProject/korean_ocr_using_paddleOCR/data/images/' \
           'Screenshot from 2023-11-21 11-20-02.jpg'
...
# Redact specific regions and apply blurring
redact_specific_regions(img_path, ocr_results, indices_to_redact)
