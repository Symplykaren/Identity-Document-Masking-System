...
# import base64
# import io
# from ocr_and_redaction import *
#
#
# app = Flask(__name__)
#
# # Instantiate PaddleOCR
# ocr_instance = MyPaddleOCR()
# def perform_face_redaction(image_data):
#     try:
#         # Convert image data to numpy array
#         nparr = np.frombuffer(image_data, np.uint8)
...
#
#         # Perform text redaction
#         processed_image_data = perform_text_redaction(image_data)
#
#         # Return the processed image
#         return send_file(io.BytesIO(processed_image_data), mimetype='image/png')
#
...
#         print(f"Exception: {e}")
#
# def perform_text_redaction(image_data):
#     try:
#         # Convert image data to numpy array
#         nparr = np.frombuffer(image_data, np.uint8)
#         img = cv2.imdecode(nparr, cv2.IMREAD_COLOR)
